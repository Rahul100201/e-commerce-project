...
@section('content')
    <div class="content mt-3">
        <div class="animated fadeIn">
            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                <button type="button" class="btn btn-outline-warning me-md-2 btn-lg" data-toggle="modal"
                                    ...
                                    <tbody>
                                        @foreach ($banner as $a)
                                            <tr>
                                                ...
                                                <td>{{ $a->description }}</td>
                                                <td><img src="{{ url('/upload/banner/' . $a->image) }}"
                                                ...
                                                <td>
                                                    <button style="border-radius: 100%" class="btn btn-success mb-1"
                                                        data-toggle="modal" data-target="#view_model-{{ $a->id }}">
                                                        <i class="fa fa-eye"></i>
                                                    </button>
                                                    <button style="border-radius: 100%" class="btn btn-secondary mb-1"
                                                        data-toggle="modal" data-target="#edit_model-{{ $a->id }}">
                                                        <i class="fa fa-pencil"></i>
                                                    </button>
                                                    <button style="border-radius: 100%" class="btn btn-danger mb-1"
                                                        data-toggle="modal"
                                                        data-target="#delete_model-{{ $a->id }}">
    ...
    @foreach ($banner as $data)
        <!------------------------------------------View Model------------------------------------------------>
        <!--View Modal -->
        <div class="modal fade" id="view_model-{{ $data->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row form-group">
                            <div class="col col-md-3">
                                <img src="{{ url('/upload/banner/' . $a->image) }}"
        ...
        <!------------------------------------------Edit Model------------------------------------------------>
        <!--Edit Modal -->
        <div class="modal fade" id="edit_model-{{ $data->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        @if ($errors->any())
                            ...
                            @endforeach
                        @endif
                        <form action="{{ url('admin/banner/update', $data->id) }}" method="post" id=""
        ...
        <!------------------------------------------Delete Model------------------------------------------------>
        <!--Delete Modal -->
        <div class="modal fade" id="delete_model-{{ $data->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-footer">
                        ...
                        <form action="{{ url('admin/banner/delete', $data->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
                ...
                <div class="modal-body">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <form method="post" action="{{ url('admin/dashboard/banner/register') }}"
